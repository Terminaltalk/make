    ...
    .setTimestamp()
        ...
        if (setting.has(`subscribe_room_${interaction.guild.id}`)) {
            ...
            const select2 = new StringSelectMenuBuilder()
                ...
                new StringSelectMenuOptionBuilder()
            .setLabel('Monster')
            .setDescription('الاشتراك في بوت الميكر الوحش')
            .setValue('Bot_Maker_Subscribe'),
            new StringSelectMenuOptionBuilder()
            .setLabel('Emperor')
            .setDescription('الاشتراك في بوت الميكر الامبراطور')
            .setValue('Bot_Maker_Premium_Subscribe'),
                    new StringSelectMenuOptionBuilder()
                        .setLabel('اعـاده تـحـمـيـل الـمـنـيـو')
                        .setDescription('عـمـل اعـاده تـحـمـيـل الـمـنـيـو')
                        .setValue('Reset_Selected'),
                );
